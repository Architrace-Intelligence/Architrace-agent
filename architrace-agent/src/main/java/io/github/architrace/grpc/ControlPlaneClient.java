...
import io.github.architrace.grpc.proto.ControlPlaneServiceGrpc.ControlPlaneServiceStub;
...
public class ControlPlaneClient implements AutoCloseable {
  ...
  public void start() {
    ControlPlaneServiceStub stub = ControlPlaneServiceGrpc.newStub(channel);
